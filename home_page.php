...
<body>
  ...
  <div class="carousel-item active">
      <img src="Images/management.jpg" class="w-100" style="height:500px;" alt="...">
    </div>
    <div class="carousel-item">
      <img src="Images/budget rule.png" class="w-100" style="height:500px;" alt="...">
    </div>
    <div class="carousel-item">
      <img src="Images/types.jpg" class="w-100" style="height:500px;" alt="...">
    </div>
    <div class="carousel-item">
      <img src="Images/st.png" class="w-100" style="height:500px;" alt="...">
    </div>
    <div class="carousel-item">
      <img src="Images/saving.webp" class="w-100" style="height:500px;" alt="...">
    </div>
    <div class="carousel-item">
      <img src="Images/third.jpg" class="w-100" style="height:500px;" alt="...">
    </div>
  </div>
